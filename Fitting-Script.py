...
# Make sure to change path below (remove Updated Spectra)
source = '8398-57870-0908'
...
# Replace Updated Spectra with Line Complex Properties (Updated Spectra is for
# Liza's data)

fit_plots = '/Users/lmm8709/PyQSOFit/Fit Results/Updated Spectra/'+source+'/'
if os.path.isdir(fit_plots) == False:
    os.makedirs(fit_plots, mode=0o777)

fit_data = '/Users/lmm8709/PyQSOFit/Fit Results/Updated Spectra/'+source+'/Fit Data/'
if os.path.isdir(fit_data) == False:
    os.makedirs(fit_data, mode=0o777)

line_complex_plots = '/Users/lmm8709/PyQSOFit/Fit Results/Updated Spectra/'+source+'/Line Profile Plots/'
...
path5 = path2+'Updated Spectra/'+source+'/'
