...
L05_waveint = np.interp(0.95, EL_cdf, EL_wave)
print(L05_waveint)
...
# ---
# FWHM calculation
FWHM90 = max(M90_flux)/2
FWHM_range90 = M90.loc[(M90['Flux'] >= FWHM90)]
FWHM_wave_min90 = FWHM_range90['Wavelength'].iloc[0]
FWHM_wave_max90 = FWHM_range90['Wavelength'].iloc[-1]
FWHM_wave90 = FWHM_wave_max90 - FWHM_wave_min90    
FWHM_kms90 = FWHM_wave90 / 6564.61 * 299792
# Kurtosis
K = 1.397*FWHM_kms90/IPV10 
print('K =', K)
# Plot Stuff
plt.figure(1)
...
plt.text(low90+40, +5, 'a', c='darkgreen', fontsize=12)
plt.hlines(0, median90, high90, linewidth=3, color='purple')
plt.text(high90-40, +5, 'b', c='purple', fontsize=12)
# Labels and title
