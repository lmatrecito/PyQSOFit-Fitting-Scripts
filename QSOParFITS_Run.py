...
(6564.61, r'H$\alpha$', 6200, 6900, 'Ha_br',       3,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.0500,     0.0150, 0, 0, 0, 0.05,    1),
(6564.61, r'H$\alpha$', 6200, 6900, 'Ha_na',       1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 0, 0.002,   1),
(6564.61, r'H$\alpha$', 6200, 6900, 'Ha_na_w',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.015, 0, 0, 0, 0.002,   1),
(6549.85, r'H$\alpha$', 6200, 6900, 'NII6549',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 2, 0.001,   1),
(6585.28, r'H$\alpha$', 6200, 6900, 'NII6585',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 2, 0.003,   1),
(6718.29, r'H$\alpha$', 6200, 6900, 'SII6718',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 1, 0.001,   1),
(6732.67, r'H$\alpha$', 6200, 6900, 'SII6732',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 1, 0.001,   1),
...
(5877.29, 'HeI',        5750, 6000, 'HeI5877_br',  1,   0.1, 0.0, 1e10,   0.0015, 0.0012, 0.0500,     0.010, 0, 0, 0, 0.001,    1), # Added on November 30, 2022 
...
#(4890.00, r'H$\beta$',  4600, 5000, 'Hb_br3',      1,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.05000,    0.0150, 0, 0, 0, 0.01,    1),

(4862.68, r'H$\beta$',  4700, 5200, 'Hb_br',       3,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.050000,   0.0150, 0, 0, 0, 0.01,    1),
(4862.68, r'H$\beta$',  4600, 5200, 'Hb_na',       1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 0, 0.002,   1),
(4862.68, r'H$\beta$',  4600, 5200, 'Hb_na_w',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 2, 2, 0, 0.002,   1),
(4960.30, r'H$\beta$',  4600, 5200, 'OIII4959c',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 1, 0.33,    1),
(5008.24, r'H$\beta$',  4600, 5200, 'OIII5007c',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 1, 1, 1, 1,       1),
(4960.30, r'H$\beta$',  4600, 5200, 'OIII4959w',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 2, 2, 2, 0.33,    1),
(5008.24, r'H$\beta$',  4600, 5200, 'OIII5007w',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0015, 2, 2, 2, 1,       1),
#(4687.02, r'H$\beta$',  4600, 5200, 'HeII4687_br', 1,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.0500,     0.0015, 0, 0, 0, 0.001,   1),
(4687.02, r'H$\beta$',  4600, 5200, 'HeII4687_na', 1,   0.1, 0.0, 10,     0.0002, 0.0001,   0.001414,   0.0015, 2, 2, 0, 0.001,   1),

# Liza Matrecito - Added the following lines - September 22, 2022:
(4341.68, r'H$\gamma$', 4200, 4500, 'Hg_br',      2,   0.1, 0.0, 1e10,     0.0015, 0.001415, 0.500,    0.015, 0, 0, 0, 0.01,    1),
(4341.68, r'H$\gamma$', 4200, 4500, 'Hg_na',      1,   0.1, 0.0, 1e10,     0.0002, 0.0001, 0.001414,   0.0015, 1, 1, 0, 0.002,   1),
#(4341.68, r'H$\gamma$', 4200, 4500, 'Hg_na_w',    1,   0.1, 0.0, 1e10,     0.0002, 0.0001, 0.0012,    0.010, 2, 2, 0, 0.002,   1),
(4364.44, r'H$\gamma$', 4200, 4500, 'OIII4364c',  1,   0.1, 0.0, 1e10,     0.0002, 0.0001, 0.001414,   0.0015, 1, 1, 0, 0.002,   1),
...
(2798.75, 'MgII', 2600, 2900, 'MgII_br',          2,   0.1, 0.0, 1e10,    0.0015, 0.001415, 0.0500,   0.015,  0, 0, 0, 0.05,  1),
(2798.75, 'MgII', 2600, 2900, 'MgII_na',          1,   0.1, 0.1, 1e10,    0.0002, 0.0005, 0.001414,   0.0015, 1, 1, 0, 0.002, 1),
