...
(6564.61, r'H$\alpha$', 6200, 6900, 'Ha_br',       2,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.0500,     0.0500, 0, 0, 0, 0.05,    1),
(6564.61, r'H$\alpha$', 6200, 6900, 'Ha_na',       1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 0, 0.002,   1),
(6564.61, r'H$\alpha$', 6200, 6900, 'Ha_na_w',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 0, 0, 0, 0.002,   1),
(6549.85, r'H$\alpha$', 6200, 6900, 'NII6549',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 2, 0.001,   1),
(6585.28, r'H$\alpha$', 6200, 6900, 'NII6585',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 2, 0.003,   1),
(6718.29, r'H$\alpha$', 6200, 6900, 'SII6718',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 1, 0.001,   1),
(6732.67, r'H$\alpha$', 6200, 6900, 'SII6732',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 1, 0.001,   1),
(6302.05, r'H$\alpha$', 6200, 6900, 'OI6302',      1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 0, 0.001,    1),
...
(4862.68, r'H$\beta$',  4600, 5200, 'Hb_br',       2,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.0500,     0.0500, 0, 0, 0, 0.01,    1),
(4862.68, r'H$\beta$',  4600, 5200, 'Hb_na',       1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 0, 0.002,   1),
(4862.68, r'H$\beta$',  4600, 5200, 'Hb_na_w',     1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 2, 2, 0, 0.002,   1),
(4960.30, r'H$\beta$',  4600, 5200, 'OIII4959c',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 1, 0.33,    1),
(4960.30, r'H$\beta$',  4600, 5200, 'OIII4959w',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 2, 2, 2, 0.33,    1),
(5008.24, r'H$\beta$',  4600, 5200, 'OIII5007c',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 1, 1,       1),
(5008.24, r'H$\beta$',  4600, 5200, 'OIII5007w',   1,   0.1, 0.0, 1e10,   0.0002, 0.0001,   0.001414,   0.0025, 2, 2, 2, 1,       1),

#(4687.02, 'HeII',       4400, 4800, 'HeII4687_br', 1,   0.1, 0.0, 1e10,   0.0015, 0.001415, 0.0100,     0.0015, 0, 0, 0, 0.001,   1),
(4687.02, r'H$\beta$',  4400, 4800, 'HeII4687_na', 1,   0.1, 0.0, 10,     0.0002, 0.0001,   0.001414,   0.0025, 1, 1, 0, 0.001,   1),
...
#(4102.98, r'H$\delta$', 4000, 4300, 'Hd_na',      1,   0.1, 0.0, 10,     0.0002, 0.0001, 0.001414,  0.010, 1, 1, 0, 0.002,   1),
# end of Liza Matrecito edits
...
(2798.75, 'MgII', 2500, 3000, 'MgII_br',          2,   0.1, 0.0, 1e10,    0.0015, 0.001415, 0.0500,    0.0500, 0, 0, 0, 0.05,  1),
(2798.75, 'MgII', 2500, 3000, 'MgII_na',          1,   0.1, 0.1, 1e10,    0.0002, 0.0001, 0.001414,    0.0015, 1, 1, 0, 0.002, 1),
